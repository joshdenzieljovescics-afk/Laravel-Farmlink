    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-12 text-center">
            <div class="max-w-md mx-auto">
                ...
                <h2 class="text-3xl font-bold text-gray-800 mb-4">Order History Coming Soon</h2>
                <p class="text-gray-600 mb-8">We're working on bringing you a comprehensive order tracking system. You'll soon be able to view all your past orders, track deliveries, and more!</p>
