                ...
                <form action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-10">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-sm font-bold text-gray-700 uppercase">Product Images</h3>
                            </div>
                        ...
                        <div class="mb-6">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-sm font-bold text-gray-700 uppercase">Special Features</h3>
                            </div>
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
                        <div class="flex flex-col sm:flex-row gap-4">
                            <button type="submit" 
                                    class="flex-1 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center">
                            ...
                            <a href="{{ route('seller.dashboard') }}" 
                               class="flex-1 bg-white hover:bg-gray-100 text-gray-700 py-3 rounded-xl font-semibold border-2 border-gray-300 hover:border-gray-400 transition-all duration-200 flex items-center justify-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
