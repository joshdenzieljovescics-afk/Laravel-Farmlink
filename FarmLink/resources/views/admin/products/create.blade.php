...
<head>
    ...
    <title>Add New Product - FarmLink Admin</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-green-100">Add a new product to the FarmLink marketplace</p>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" 
                                          id="description" 
                                          rows="5" 
                                          placeholder="Describe the product, including freshness, origin, and any special qualities..."
